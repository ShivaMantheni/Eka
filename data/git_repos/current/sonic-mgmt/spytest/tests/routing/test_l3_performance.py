...
def l3_performance_enhancements_module_hooks(request):
    ...
    hw_list = ['accton-as4630-54pe', 'dellemc-n3248te', 'dellemc-n3248pxe', 'dellemc-n3248x', 'accton-as5835-54t', 'accton-as4630-54te', 'accton-as4630-54npe', 'dell-e3248p']
    hw_list_td3_x2 = ['celestica-belgite', 'alphanetworks-bes2348t', 'alphanetworks-scg60d0-484t']
