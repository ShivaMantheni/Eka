__all__ = ["CLEANUP_KEY", "IPV6_VXLAN_TEST_KEY", "APPLY_NEW_CONFIG_KEY", "NUM_VNET_KEY", "NUM_ROUTES_KEY",
           "NUM_ENDPOINTS_KEY", "NUM_INTF_PER_VNET_KEY", "DUT_VNET_SWITCH_JSON", "DUT_VNET_CONF_JSON",
           "DUT_VNET_ROUTE_JSON", "DUT_VNET_INTF_JSON", "DUT_VNET_NBR_JSON", "DUT_VXLAN_RANGE_JSON",
