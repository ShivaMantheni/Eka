...
from tests.snappi_tests.bgp.files.bgp_outbound_helper import run_bgp_outbound_uplink_blackout_test   # noqa: F401
...
def test_bgp_outbound_uplink_blackout(snappi_api,                                     # noqa: F811
                                      ...
                                      record_property):
    """
    Gets the packet loss duration on flapping portchannels in uplink side.
    Tests both complete blackout (100%) and partial blackout (50%) in a single
    ...
    snappi_extra_params.test_name = "T2 Uplink"
    snappi_extra_params.multi_dut_params.BLACKOUT_PERCENTAGES = BLACKOUT_PERCENTAGES
