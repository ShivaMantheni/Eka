...
from tests.snappi_tests.bgp.files.bgp_outbound_helper import run_bgp_outbound_process_restart_test   # noqa: F401
...
def test_bgp_outbound_uplink_process_crash(snappi_api,                                     # noqa: F811
                                           ...
                                           record_property):
    """
    Gets the packet loss duration on killing certain processes in uplink
    ...
    snappi_extra_params.test_name = "T2 Uplink Process Crash"
    ...
    if topology_type == TOPOLOGY_T2_PIZZABOX:
        ...
        snappi_extra_params.multi_dut_params.host_name = device_hostnames[1]  # T2 Pizzabox
    else:
        ...
        snappi_extra_params.multi_dut_params.host_name = device_hostnames[1]  # Uplink LC
