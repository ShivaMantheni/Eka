...
def test_bgp_outbound_downlink_process_crash(snappi_api,                                     # noqa: F811
    ...
    # Skip for Pizzabox - uplink process crash test covers all ASICs
    if topology_type == TOPOLOGY_T2_PIZZABOX:
        pytest.skip("Downlink process crash not applicable for Pizzabox - uplink test covers all ASICs")
    ...
    snappi_extra_params.multi_dut_params.host_name = device_hostnames[2]  # Downlink LC
